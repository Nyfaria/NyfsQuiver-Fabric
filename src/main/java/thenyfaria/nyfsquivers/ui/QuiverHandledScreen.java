...
import thenyfaria.nyfsquivers.api.Rectangle;

public class QuiverHandledScreen extends AbstractContainerScreen<QuiverScreenHandler> {

    private static final ResourceLocation GUI_TEXTURE = new ResourceLocation("nyfsquivers", "textures/gui/quiver_container.png");
